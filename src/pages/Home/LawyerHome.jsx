        ...
        <section className="cases-card">
          ...
          <div className="cases-table">
            ...
            {filteredCases.map((c, idx) => (
              ...
              >
                <span>{idx + 1}</span>
                <span>{c.client_name || 'ΓÇö'}</span>
                <span>{c.matter_title || 'ΓÇö'}</span>
                <span>{c.matter_type || 'ΓÇö'}</span>
                <span>{c.file_code || c.id || 'ΓÇö'}</span>
                <span>{c.open_date || 'ΓÇö'}</span>
                <span>{c.close_date || '—'}</span>
                <span>
                  <span className={statusClass(c.status)}>{c.status || 'ΓÇö'}</span>
                </span>
              </div>
            ))}
          </div>
